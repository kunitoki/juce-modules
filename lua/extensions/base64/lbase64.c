...
#define BASE64_NAME		"base64"
#define BASE64_VERSION	BASE64_NAME " library for " LUA_VERSION " / Mar 2010"
...
#define luaL_register(L,n,f)    luaL_setfuncs(L,f,0); lua_setglobal(L, n)
#endif

static const luaL_Reg BASE64_R[] =
{
	{ "encode",	Lencode	},
	{ "decode",	Ldecode	},
	{ NULL,		NULL	}
...
{
 luaL_register(L, BASE64_NAME, BASE64_R);
 lua_pushliteral(L, "version");			/** version */
 lua_pushliteral(L, BASE64_VERSION);
 lua_settable(L,-3);
 return 1;
}
